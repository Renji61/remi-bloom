      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="flex items-center justify-center rounded-lg bg-blue-500/10 p-1.5 text-blue-400 transition-colors hover:bg-blue-500/20"
          ...
          <button
            ...
            className="flex items-center justify-center rounded-lg bg-emerald-500/10 p-1.5 text-emerald-400 transition-colors hover:bg-emerald-500/20"
